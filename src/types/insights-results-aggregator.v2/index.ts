...
export type SchemaClusterId = components["schemas"]["clusterId"];
export type SchemaClusterList = components["schemas"]["clusterList"];
export type SchemaClusterListResponse =
  components["schemas"]["clusterListResponse"];
export type SchemaDvoReportMeta = components["schemas"]["dvoReportMeta"];
export type SchemaGatheringRequests =
  components["schemas"]["gatheringRequests"];
export type SchemaNamespaceId = components["schemas"]["namespaceId"];
export type SchemaOperatorCondition =
  components["schemas"]["operator_condition"];
export type SchemaRatingSchema = components["schemas"]["ratingSchema"];
export type SchemaRecommendationList =
  components["schemas"]["recommendationList"];
export type SchemaRecommendationListResponse =
  components["schemas"]["recommendationListResponse"];
export type SchemaReport = components["schemas"]["report"];
export type SchemaReportData = components["schemas"]["reportData"];
export type SchemaReportMeta = components["schemas"]["reportMeta"];
...
export type SchemaSimplifiedReport = components["schemas"]["simplifiedReport"];
export type SchemaStatusResponse = components["schemas"]["statusResponse"];
export type SchemaSystemWideRuleDisable =
  components["schemas"]["systemWideRuleDisable"];
export type SchemaSystemWideRuleDisableList =
  components["schemas"]["systemWideRuleDisableList"];
export type SchemaUpgradeRisksPrediction =
  components["schemas"]["upgradeRisksPrediction"];
export type SchemaUpgradeRisksPredictors =
  components["schemas"]["upgradeRisksPredictors"];
