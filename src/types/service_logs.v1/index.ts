...
export type SchemaClusterLog = components["schemas"]["ClusterLog"];
export type SchemaClusterLogList = components["schemas"]["ClusterLogList"];
...
export type SchemaWarehouseCount = components["schemas"]["WarehouseCount"];
...
export type ParameterSubscriptionId =
  components["parameters"]["subscription_id"];
