...
export type SchemaAwsCapacityReservation =
  components["schemas"]["AWSCapacityReservation"];
...
export type SchemaAwsSpotMarketOptions =
  components["schemas"]["AWSSpotMarketOptions"];
export type SchemaAwsVolume = components["schemas"]["AWSVolume"];
export type SchemaAwsstsAccountRole =
  components["schemas"]["AWSSTSAccountRole"];
...
export type SchemaCidrBlockAllowAccess =
  components["schemas"]["CIDRBlockAllowAccess"];
...
export type SchemaHtPasswdIdentityProvider =
  components["schemas"]["HTPasswdIdentityProvider"];
...
export type SchemaLdapIdentityProvider =
  components["schemas"]["LDAPIdentityProvider"];
export type SchemaSts = components["schemas"]["STS"];
export type SchemaStsCredentialRequest =
  components["schemas"]["STSCredentialRequest"];
...
export type SchemaAddOnEnvironmentVariable =
  components["schemas"]["AddOnEnvironmentVariable"];
export type SchemaAddOnInstallation =
  components["schemas"]["AddOnInstallation"];
export type SchemaAddOnInstallationBilling =
  components["schemas"]["AddOnInstallationBilling"];
export type SchemaAddOnInstallationParameter =
  components["schemas"]["AddOnInstallationParameter"];
...
export type SchemaAddOnParameterOption =
  components["schemas"]["AddOnParameterOption"];
export type SchemaAddOnRequirement = components["schemas"]["AddOnRequirement"];
export type SchemaAddOnRequirementStatus =
  components["schemas"]["AddOnRequirementStatus"];
export type SchemaAddOnSecretPropagation =
  components["schemas"]["AddOnSecretPropagation"];
...
export type SchemaAdditionalCatalogSource =
  components["schemas"]["AdditionalCatalogSource"];
export type SchemaAddonUpgradePolicy =
  components["schemas"]["AddonUpgradePolicy"];
export type SchemaAddonUpgradePolicyState =
  components["schemas"]["AddonUpgradePolicyState"];
...
export type SchemaAutoscalerResourceLimits =
  components["schemas"]["AutoscalerResourceLimits"];
export type SchemaAutoscalerResourceLimitsGpuLimit =
  components["schemas"]["AutoscalerResourceLimitsGPULimit"];
export type SchemaAutoscalerScaleDownConfig =
  components["schemas"]["AutoscalerScaleDownConfig"];
export type SchemaAwsAutoNode = components["schemas"]["AwsAutoNode"];
export type SchemaAwsEtcdEncryption =
  components["schemas"]["AwsEtcdEncryption"];
...
export type SchemaAzureEtcdDataEncryption =
  components["schemas"]["AzureEtcdDataEncryption"];
export type SchemaAzureEtcdDataEncryptionCustomerManaged =
  components["schemas"]["AzureEtcdDataEncryptionCustomerManaged"];
export type SchemaAzureEtcdEncryption =
  components["schemas"]["AzureEtcdEncryption"];
export type SchemaAzureKmsEncryption =
  components["schemas"]["AzureKmsEncryption"];
...
export type SchemaAzureNodePoolOsDisk =
  components["schemas"]["AzureNodePoolOsDisk"];
...
export type SchemaBreakGlassCredential =
  components["schemas"]["BreakGlassCredential"];
...
export type SchemaCloudProviderData =
  components["schemas"]["CloudProviderData"];
...
export type SchemaClusterAutoNodeStatus =
  components["schemas"]["ClusterAutoNodeStatus"];
export type SchemaClusterAutoscaler =
  components["schemas"]["ClusterAutoscaler"];
export type SchemaClusterConsole = components["schemas"]["ClusterConsole"];
export type SchemaClusterCredentials =
  components["schemas"]["ClusterCredentials"];
export type SchemaClusterDeployment =
  components["schemas"]["ClusterDeployment"];
export type SchemaClusterImageRegistry =
  components["schemas"]["ClusterImageRegistry"];
...
export type SchemaClusterMigrationState =
  components["schemas"]["ClusterMigrationState"];
export type SchemaClusterNodes = components["schemas"]["ClusterNodes"];
export type SchemaClusterOperatorInfo =
  components["schemas"]["ClusterOperatorInfo"];
export type SchemaClusterOperatorsInfo =
  components["schemas"]["ClusterOperatorsInfo"];
export type SchemaClusterRegistration =
  components["schemas"]["ClusterRegistration"];
export type SchemaClusterRegistryConfig =
  components["schemas"]["ClusterRegistryConfig"];
...
export type SchemaControlPlaneUpgradePolicy =
  components["schemas"]["ControlPlaneUpgradePolicy"];
export type SchemaCredentialRequest =
  components["schemas"]["CredentialRequest"];
...
export type SchemaExternalAuthClaim =
  components["schemas"]["ExternalAuthClaim"];
export type SchemaExternalAuthClientConfig =
  components["schemas"]["ExternalAuthClientConfig"];
export type SchemaExternalAuthConfig =
  components["schemas"]["ExternalAuthConfig"];
export type SchemaExternalAuthState =
  components["schemas"]["ExternalAuthState"];
export type SchemaExternalAuthStatus =
  components["schemas"]["ExternalAuthStatus"];
export type SchemaExternalConfiguration =
  components["schemas"]["ExternalConfiguration"];
export type SchemaFlavour = components["schemas"]["Flavour"];
export type SchemaFlavourNodes = components["schemas"]["FlavourNodes"];
export type SchemaGcpAuthentication =
  components["schemas"]["GcpAuthentication"];
export type SchemaGcpDnsDomain = components["schemas"]["GcpDnsDomain"];
export type SchemaGcpPrivateServiceConnect =
  components["schemas"]["GcpPrivateServiceConnect"];
export type SchemaGcpSecurity = components["schemas"]["GcpSecurity"];
export type SchemaGithubIdentityProvider =
  components["schemas"]["GithubIdentityProvider"];
export type SchemaGitlabIdentityProvider =
  components["schemas"]["GitlabIdentityProvider"];
export type SchemaGoogleIdentityProvider =
  components["schemas"]["GoogleIdentityProvider"];
...
export type SchemaLimitedSupportReason =
  components["schemas"]["LimitedSupportReason"];
...
export type SchemaLogForwarderS3Config =
  components["schemas"]["LogForwarderS3Config"];
export type SchemaLogForwarderApplication =
  components["schemas"]["LogForwarderApplication"];
export type SchemaLogForwarderCloudWatchConfig =
  components["schemas"]["LogForwarderCloudWatchConfig"];
export type SchemaLogForwarderGroup =
  components["schemas"]["LogForwarderGroup"];
export type SchemaLogForwarderGroupVersion =
  components["schemas"]["LogForwarderGroupVersion"];
export type SchemaLogForwarderGroupVersions =
  components["schemas"]["LogForwarderGroupVersions"];
export type SchemaLogForwarderStatus =
  components["schemas"]["LogForwarderStatus"];
export type SchemaMachinePool = components["schemas"]["MachinePool"];
export type SchemaMachinePoolAutoscaling =
  components["schemas"]["MachinePoolAutoscaling"];
...
export type SchemaMachineTypeFeatures =
  components["schemas"]["MachineTypeFeatures"];
export type SchemaManagedService = components["schemas"]["ManagedService"];
export type SchemaManifest = components["schemas"]["Manifest"];
export type SchemaNamespaceSelector =
  components["schemas"]["NamespaceSelector"];
export type SchemaNetwork = components["schemas"]["Network"];
export type SchemaNetworkVerification =
  components["schemas"]["NetworkVerification"];
export type SchemaNodeInfo = components["schemas"]["NodeInfo"];
export type SchemaNodePool = components["schemas"]["NodePool"];
export type SchemaNodePoolAutoscaling =
  components["schemas"]["NodePoolAutoscaling"];
export type SchemaNodePoolManagementUpgrade =
  components["schemas"]["NodePoolManagementUpgrade"];
...
export type SchemaNodePoolUpgradePolicy =
  components["schemas"]["NodePoolUpgradePolicy"];
...
export type SchemaOidcThumbprintInput =
  components["schemas"]["OidcThumbprintInput"];
export type SchemaOpenIdClaims = components["schemas"]["OpenIDClaims"];
export type SchemaOpenIdIdentityProvider =
  components["schemas"]["OpenIDIdentityProvider"];
...
export type SchemaPendingDeleteCluster =
  components["schemas"]["PendingDeleteCluster"];
export type SchemaPrivateLinkClusterConfiguration =
  components["schemas"]["PrivateLinkClusterConfiguration"];
export type SchemaPrivateLinkConfiguration =
  components["schemas"]["PrivateLinkConfiguration"];
export type SchemaPrivateLinkPrincipal =
  components["schemas"]["PrivateLinkPrincipal"];
export type SchemaPrivateLinkPrincipals =
  components["schemas"]["PrivateLinkPrincipals"];
export type SchemaProduct = components["schemas"]["Product"];
export type SchemaProductMinimalVersion =
  components["schemas"]["ProductMinimalVersion"];
export type SchemaProductTechnologyPreview =
  components["schemas"]["ProductTechnologyPreview"];
export type SchemaProvisionShard = components["schemas"]["ProvisionShard"];
export type SchemaProxy = components["schemas"]["Proxy"];
export type SchemaRegistryAllowlist =
  components["schemas"]["RegistryAllowlist"];
...
export type SchemaReleaseImageDetails =
  components["schemas"]["ReleaseImageDetails"];
...
export type SchemaRolePolicyBinding =
  components["schemas"]["RolePolicyBinding"];
export type SchemaRolePolicyBindingStatus =
  components["schemas"]["RolePolicyBindingStatus"];
export type SchemaRootVolume = components["schemas"]["RootVolume"];
export type SchemaSdnToOvnClusterMigration =
  components["schemas"]["SdnToOvnClusterMigration"];
...
export type SchemaStsSupportJumpRole =
  components["schemas"]["StsSupportJumpRole"];
export type SchemaSubnetNetworkVerification =
  components["schemas"]["SubnetNetworkVerification"];
...
export type SchemaTokenClaimMappings =
  components["schemas"]["TokenClaimMappings"];
export type SchemaTokenClaimValidationRule =
  components["schemas"]["TokenClaimValidationRule"];
...
export type SchemaUpgradePolicyState =
  components["schemas"]["UpgradePolicyState"];
...
export type SchemaVersionGateAgreement =
  components["schemas"]["VersionGateAgreement"];
...
export type SchemaWifCredentialRequest =
  components["schemas"]["WifCredentialRequest"];
export type SchemaWifGcp = components["schemas"]["WifGcp"];
export type SchemaWifIdentityProvider =
  components["schemas"]["WifIdentityProvider"];
export type SchemaWifPool = components["schemas"]["WifPool"];
export type SchemaWifResourceBinding =
  components["schemas"]["WifResourceBinding"];
export type SchemaWifRole = components["schemas"]["WifRole"];
export type SchemaWifSecretRef = components["schemas"]["WifSecretRef"];
export type SchemaWifServiceAccount =
  components["schemas"]["WifServiceAccount"];
