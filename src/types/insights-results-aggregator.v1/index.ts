...
export type SchemaOverviewResponse = components["schemas"]["overviewResponse"];
export type SchemaReportData = components["schemas"]["reportData"];
export type SchemaReportsComponent = components["schemas"]["reportsComponent"];
export type SchemaReportsResponse = components["schemas"]["reportsResponse"];
export type SchemaRuleContent = components["schemas"]["ruleContent"];
export type SchemaRuleContentErrorKey =
  components["schemas"]["ruleContentErrorKey"];
export type SchemaRuleContentPlugin =
  components["schemas"]["ruleContentPlugin"];
